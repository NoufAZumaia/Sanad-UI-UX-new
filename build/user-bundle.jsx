        ...
        <div style={{ padding: '20px 16px 0' }}>
          ...
          <div style={{ display: 'flex', gap: 10, overflowX: 'auto' }}>
            {[
              ...
              { l: 'موعد طبي', i: 'hospital', c: '#2E73C9' },
              { l: 'وثائق', i: 'doc', c: '#14318F' },
            ].map(q => (
      ...
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 100 }}>
        ...
        <div style={{ padding: '0 16px' }}>
          ...
          <Card theme={t} padding={0} style={{ overflow: 'hidden' }}>
            {[
              { t1: 'موعد مستشفى الملك فيصل', t2: 'سند مرافقة · ٩:٣٠ ص', tag: 'اليوم', c: '#2E73C9' },
              { t1: 'جلسة قراءة — والدة', t2: 'سند جليس · ٤:٠٠ م', tag: 'اليوم', c: t.accent },
              { t1: 'برنامج محاسبة — تدريب', t2: 'سند أكاديمي · ٨:٣٠ ص', tag: 'الأحد', c: '#14318F' },
            ].map((row, i, a) => (
...
function ScrNotifications({ theme: t }) {
  ...
  const groups = [
    ...
    { title: 'هذا الأسبوع', items: [
      ...
      { i: 'graduation', c: '#14318F', t: 'تم قبول طلب التدريب', d: 'برنامج محاسبة تطبيقي', time: 'أول أمس' },
      { i: 'calendar', c: '#2E73C9', t: 'تذكير بالموعد الطبي غدًا', d: 'الملك فيصل التخصصي · ٩:٣٠ ص', time: 'الجمعة' },
    ]},
  ];
  return (
    <Screen theme={t}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 100, padding: '6px 20px 100px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10, marginBottom: 20 }}>
          {[
            ...
            { v: '٥', l: 'سند مرافقة', i: 'shield', c: '#2E73C9' },
          ].map((s, i) => (
...
function ScrNotifications({ theme: t }) {
  ...
  const groups = [
    ...
    { label: 'هذا الأسبوع', items: [
      ...
      { i: 'shield', c: '#2E73C9', t: 'موعد مرافقة بعد غد', d: 'الملك فيصل التخصصي · ٩:٣٠ ص', time: 'الأحد' },
...
if (typeof document !== 'undefined' && !document.getElementById('dc-styles')) {
  ...
  s.textContent = [
    ...
    '.dc-expand:hover,.dc-kebab:hover{background:rgba(0,0,0,.06);color:#1A2138}',
    ...
    '  color:#0E152B;cursor:pointer;text-align:left;transition:background .12s;white-space:nowrap}',
    ...
    <div onClick={() => ctx.setFocus(null)}
      ...
      <div onClick={(e) => e.stopPropagation()}
        ...
        <div style={{ position: 'relative' }}>
          ...
          {ddOpen && (
            <div style={{ position: 'absolute', top: '100%', left: 0, marginTop: 4, background: '#1A2138', borderRadius: 8,
...
const __TWEAKS_STYLE = `
  .twk-panel{position:fixed;right:16px;bottom:16px;z-index:2147483646;width:280px;
    ...
    background:rgba(250,249,247,.78);color:#0E152B;
  ...
  .twk-x:hover{background:rgba(0,0,0,.06);color:#0E152B}
